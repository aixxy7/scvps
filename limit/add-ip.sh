...
data_ip="https://raw.githubusercontent.com/aixxy7/scvps/main/izinIP"
checking_sc() {
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/aixxy7/scvps/main/"
cd izin
export MYIP=$( curl -sS ipv4.icanhazip.com/ )
SELLER=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $2}')
Exp100=$(curl -sS ${Repo1}ip | grep $MYIP | awk '{print $3}')
data_ip="https://raw.githubusercontent.com/aixxy7/scvps/main/izin"
cd izin
...
REPO="https://github.com/aixxy7/scvps.git"
EMAIL="aixxy72@gmail.com"
USER="aixxy7"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : Lt) : " name
    ...
    git remote add origin https://github.com/aixxy7/scvps
    git push -f https://${TOKEN}@github.com/aixxy7/scvps.git &> /dev/null
    cd izinIp
    rm -rf /root/scvps
    clear
    sleep 1
...
TIMES="10"
CHATID="69533803"
KEY="631173819:AAFYqB7pbUYA62pKQFA_fyQjEOQWoP93U"
URL="https://api.telegram.org/bot$KEY/sendMessage"
...
TIMES="10"
CHATID="6953253803"
KEY="63117419:AAFYqB7pbUYA62pKQFA_fyQjEOqzoP93U"
URL="https://api.telegram.org/bot$KEY/sendMessage"
