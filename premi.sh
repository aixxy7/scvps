...
echo -e " © DEV aixxy7${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/aixxy7/scvps/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/aixxy7/scvps/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/aixxy7/scvps/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/aixxy7/scvps/main/"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/aixxy7/scvps/main/izin | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/aixxy7/scvps/main/izin | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/aixxy7/scvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
